...
void SOC_AssignDisplayCamera(sc_rm_pt_t pt)
{
    ...
    ipc = SystemGetScfwIpcHandle();
    err = sc_rm_get_partition(ipc, &pt_m4_0);
    ...
    sc_rm_set_subsys_rsrc_movable(ipc, SC_R_CSI_0, SC_TRUE);
    sc_rm_set_subsys_rsrc_movable(ipc, SC_R_MIPI_0, SC_TRUE);
    //sc_rm_set_subsys_rsrc_movable(ipc, SC_R_MIPI_1, SC_TRUE);
    sc_rm_set_subsys_rsrc_movable(ipc, SC_R_DC_0, SC_TRUE);
    //sc_rm_set_subsys_rsrc_movable(ipc, SC_R_PI_0, SC_TRUE);
    sc_rm_set_resource_movable(ipc, SC_R_LVDS_0, SC_R_LVDS_0, SC_TRUE);
    //sc_rm_set_resource_movable(ipc, SC_R_LVDS_1, SC_R_LVDS_1, SC_TRUE);
    sc_rm_set_resource_movable(ipc, SC_R_ISI_CH0, SC_R_ISI_CH0, SC_TRUE);

    /* Move some pads not in the M4_0 subsystem */
    //sc_rm_set_pad_movable(ipc, SC_P_MIPI_CSI0_GPIO0_00, SC_P_MIPI_DSI1_I2C0_SDA, SC_TRUE);
    sc_rm_set_pad_movable(ipc, SC_P_MIPI_CSI0_GPIO0_00, SC_P_MIPI_CSI0_MCLK_OUT, SC_TRUE);
    sc_rm_set_pad_movable(ipc, SC_P_MIPI_DSI0_I2C0_SCL, SC_P_MIPI_DSI0_I2C0_SDA, SC_TRUE);

    err = sc_rm_move_all(ipc, pt_m4_0, pt_android, SC_TRUE, SC_TRUE);
