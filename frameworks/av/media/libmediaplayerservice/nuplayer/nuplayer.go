...
func init() {
    android.RegisterModuleType("nuplayer_defaults", nuplayerDefaultsFactory)
}

func nuplayerDefaultsFactory() (android.Module) {
    module := cc.DefaultsFactory()
    android.AddLoadHook(module, nuplayerDefaults)
    return module
}

func nuplayerDefaults(ctx android.LoadHookContext) {
    var cppflags []string
    type props struct {
        Cflags []string
    }
