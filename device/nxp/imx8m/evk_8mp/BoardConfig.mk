...
# display config
BOARD_KERNEL_CMDLINE +=  androidboot.primary_display=imx-drm
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
  ifeq ($(IMX_NO_PRODUCT_PARTITION),true)
    ...
    TARGET_BOARD_DTS_CONFIG := imx8mp:OK8MP-C.dtb
    # Only ov5640
    TARGET_BOARD_DTS_CONFIG += imx8mp-ov5640:OK8MP-C.dtb
    # Only basler
...
BOARD_LOGOIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_LOGOIMAGE_PARTITION_SIZE := 67108864
